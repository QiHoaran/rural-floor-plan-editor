...
from embodied.exact import Reader, fail
...
from embodied.planner import Position, collision_free, shift
...
def decode_behavior_tokens(tokens: list[str], config: Config) -> CanonicalFloorplan:
