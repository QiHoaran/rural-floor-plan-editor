...
convert_modality = getattr(multimodal, "convert_modality", None)
...
class MultimodalPipelineTest(unittest.TestCase):
    ...
    def test_recovers_interrupted_force_publication_and_tolerates_deferred_cleanup(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            (output_root / multimodal._PUBLICATION_MARKER).write_bytes(
                stable_json_bytes(
                    {
                        "schema_version": multimodal._PUBLICATION_MARKER_SCHEMA,
            ...
            real_rmtree = multimodal.shutil.rmtree
            ...
            with mock.patch.object(multimodal.shutil, "rmtree", side_effect=defer_backup_cleanup):
    ...
    def test_publication_lock_serializes_same_output_identity(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            def first_worker() -> None:
                with multimodal._publication_lock(output_root):
                    first_entered.set()
